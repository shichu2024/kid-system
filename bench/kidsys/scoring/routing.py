...
Used by routing-style dimensions (vault placement) and partially by
no-fabrication / trigger dimensions. Ported unchanged from quick-knowledge.
"""
...
def score(actual_path: str, expected_glob: str) -> tuple[float, float]:
    ...
    actual_path : str
        ...
        (e.g. ``"01_journal/2026-09/2026-09-08.md"``).
        Empty string means "no file was written".
    expected_glob : str
        Expected path glob (e.g. ``"01_journal/2026-09/*.md"``).
        Empty string means "no file expected" (no-trigger cases).
    ...
    # E.g. wrote to 01_journal/2026-09/ when expected 01_journal/archive/
